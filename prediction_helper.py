...
def preprocess_input(input_dict):
    ...
    # The order of columns must match exactly what the model expects
    expected_columns = [
        'age', 'number_of_dependants', 'income_lakhs', 'insurance_plan', 'normalized_risk_score',
        'gender_Male', 'region_Northwest', 'region_Southeast', 'region_Southwest', 'marital_status_Unmarried',
        'bmi_category_Obesity', 'bmi_category_Overweight', 'bmi_category_Underweight', 'smoking_status_Occasional',
        'smoking_status_Regular', 'employment_status_Salaried', 'employment_status_Self-Employed', 'genetical_risk'
    ]
...
def predict(input_dict):
    try:
        ...
        # Define the correct feature order based on the error message
        # The model expects this exact order of features
        model_features = [
        ...
        # If there's still an issue, return a reasonable default value
